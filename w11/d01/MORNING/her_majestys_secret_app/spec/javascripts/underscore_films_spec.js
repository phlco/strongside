  ...
  beforeEach(function(){
    this.addMatchers({
      toMatchArray: function(expected){
        var actualSorted = this.actual.sort(function(a,b){return a > b})
        var expectedSorted = expected.sort(function(a,b){return a > b})
        // var actualSorted = _.sortBy(this.actual, (function(n) { return n }) );
        // var expectedSorted = _.sortBy(expected, (function(n) { return n }) );
        this.message = function(){
          return "Expected " + this.actual + " to equal " + expected;
        }
        return _.isEqual(actualSorted, expectedSorted);
      }
    })
  })

  describe("arrays match", function(){
    it("matches arrays", function(){
      expect([1,2,3]).toMatchArray([3,4,1]);
    });
  });
