class AccountsController < ApplicationController
  ...
  before_filter :okay_user, :except => [:index, :new, :create]
  ...
  def deposit
    ...
    respond_to do |format|
      if (amount = params[:dep_amount])
        ...
        format.html { redirect_to(@account, :notice => "Account #{@account.id} was successfuly updated.") }
        format.xml { head :ok }
      else
