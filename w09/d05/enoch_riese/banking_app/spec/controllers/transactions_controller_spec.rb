...
describe TransactionsController do
  ...
  let(:valid_attributes) { { "date" => "2013-11-24" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update_attributes).with({ "date" => "2013-11-24" })
        put :update, {:id => transaction.to_param, :transaction => { "date" => "2013-11-24" }}, valid_session
      end
